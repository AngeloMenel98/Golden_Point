...
function getTeamsNeeded(categoriesCount: number, currentTeams: number = 0): number {
  ...
  return (
    ...
    >
      <div className="p-4">
        ...
        {isAdmin && (
          <div className="pt-3 border-t border-gp-gray-light" onClick={(e) => e.stopPropagation()}>
